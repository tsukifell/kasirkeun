            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="/dashboard"><img src="{{ asset('assets/images/logo/kasirkeun.png') }}"
                                    alt="Logo" srcset="" width="100px" height="100px"></a>
                        </div>
                                ...
                                <li class="sidebar-item">
                                    <form method="POST" action="{{ route('logout') }}" class='sidebar-link'>
                                        ...
                                        <a :href="route('logout')"
                                            ...
                                            <i class="bi bi-arrow-bar-left"></i>{{ __('Log Out') }}
                                        </a>
                                    </form>
                                </li>
